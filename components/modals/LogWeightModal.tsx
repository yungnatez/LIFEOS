...
export default function LogWeightModal({ open, onClose }: LogWeightModalProps) {
      ...
      <div className="bg-[#0D1525] border border-[#1E2D45] rounded-xl p-6 w-full max-w-sm shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 text-xs font-extrabold text-white bg-[#3b86f7] rounded-lg hover:bg-[#3b86f7]/90 transition-colors"
            >
              Save Entry
            </button>
          </div>
